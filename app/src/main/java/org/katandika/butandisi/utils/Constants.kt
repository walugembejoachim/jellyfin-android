...
object Constants {
    ...
    const val FRAGMENT_CONNECT_EXTRA_ERROR = "org.katandika.butandisi.intent.extra.ERROR"
    const val FRAGMENT_WEB_VIEW_EXTRA_SERVER = "org.katandika.butandisi.intent.extra.SERVER"
    ...
    const val MEDIA_NOTIFICATION_CHANNEL_ID = "org.katandika.butandisi.media.NOW_PLAYING"
    const val DOWNLOAD_NOTIFICATION_CHANNEL_ID = "org.katandika.butandisi.download.DOWNLOAD_PROGRESS"
    ...
    const val ACTION_SHOW_PLAYER = "org.katandika.butandisi.intent.action.SHOW_PLAYER"
    const val ACTION_PLAY = "org.katandika.butandisi.intent.action.PLAY"
    const val ACTION_PAUSE = "org.katandika.butandisi.intent.action.PAUSE"
    const val ACTION_REWIND = "org.katandika.butandisi.intent.action.REWIND"
    const val ACTION_FAST_FORWARD = "org.katandika.butandisi.intent.action.FAST_FORWARD"
    const val ACTION_PREVIOUS = "org.katandika.butandisi.intent.action.PREVIOUS"
    const val ACTION_NEXT = "org.katandika.butandisi.intent.action.NEXT"
    const val ACTION_STOP = "org.katandika.butandisi.intent.action.STOP"
    const val ACTION_REPORT = "org.katandika.butandisi.intent.action.REPORT"
    ...
    const val EXTRA_MEDIA_PLAY_OPTIONS = "org.katandika.butandisi.MEDIA_PLAY_OPTIONS"
